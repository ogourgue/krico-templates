...
# Open dataset.
ds = xr.open_dataset('http://tds.mercator-ocean.fr/thredds/dodsC/psy4v3r1/global-analysis-forecast-phy-001-024-pgnstatics/PSY4V3R1_mesh_hgr.nc')
...
# Save dataset.
ds.to_netcdf('glorys12_coordinates.nc', format = 'NETCDF4')